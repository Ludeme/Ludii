	...
	public Action undo(final Context context)
	{
		...
		if (countTo == 1)
		{
			...
			if(previousWhatTo > 0)
			{
				...
				{
					final int toValue =  (context.game().hasDominoes() ? 1 : previousValueTo);
					csTo.setSite(context.state(), to, previousWhoTo, previousWhatTo, 1, previousStateTo, previousRotationTo, toValue, typeTo);
			...
			else
			{
				...
				{
					final int toValue =  (context.game().hasDominoes() ? 1 : previousValueTo);
					csTo.setSite(context.state(), to, Constants.UNDEFINED, Constants.UNDEFINED, 0, previousStateTo, previousRotationTo, toValue, typeTo);
				}
			}
		}
		else
		...
		if (currentStateTo != Constants.UNDEFINED && previousStateFrom == Constants.UNDEFINED)
			...
			csFrom.setSite(context.state(), from, Constants.UNDEFINED, Constants.UNDEFINED, Constants.UNDEFINED, previousStateFrom, Constants.UNDEFINED, Constants.OFF, typeFrom);
		...
		if (currentRotationTo != Constants.UNDEFINED && previousRotationFrom == Constants.UNDEFINED)
			...
			csFrom.setSite(context.state(), from, Constants.UNDEFINED, Constants.UNDEFINED, Constants.UNDEFINED, Constants.UNDEFINED, previousRotationFrom, Constants.OFF, typeFrom);
		...
		{
			final int fromValue = (context.game().usesLineOfPlay() ? 1 : previousValueFrom);
			csFrom.setSite(context.state(), from, Constants.UNDEFINED, Constants.UNDEFINED, Constants.UNDEFINED, Constants.UNDEFINED, Constants.UNDEFINED, fromValue, typeFrom);
		}
