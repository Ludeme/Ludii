...
public class ThreatenedMaterial extends HeuristicTerm
{
	 ...
	 * weight of $0$.
	 * 
	 * @example (threatenedMaterial pieceWeights:{ (pair "Pawn" 1.0) (pair "Bishop" 3.0) })
	 */
	public ThreatenedMaterial
	(
	...
	{
		return new ThreatenedMaterial(this);
	}
	 ...
	 * @param other
	 */
	private ThreatenedMaterial(final ThreatenedMaterial other)
	{
	...
	{
		final ThreatenedMaterial castTerm = (ThreatenedMaterial) term;
		for (int i = 0; i < pieceWeightNames.length; i++)
