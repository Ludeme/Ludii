...
public class PieceForeground implements GraphicsItem
{
	 ...
	 * @param foreground	Name of the foreground image to draw.
	 ...
	 * @param scale			Scale of the drawn image relative to the cell size of the container [1.0].
