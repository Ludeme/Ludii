...
public class LargePieceStyle extends TileStyle
{
	...
	{		
		...
		if (numEdges == 3)
			boardForLargePiece = new Board(new TriangleOnTri(new DimConstant(pieceScale)), null, null, null, null, null);
		else if (numEdges == 6)
			boardForLargePiece = new Board(new HexagonOnHex(new DimConstant(pieceScale)), null, null, null, null, null);
		else if (numEdges == 4)
			boardForLargePiece = new Board(new RectangleOnSquare(new DimConstant(pieceScale), null, null, null), null, null, null, null, null);
		else
