...
\noindent
This document provides full documentation for the game description language used by the Ludii general game system. Note that the majority of this document is automatically generated. More info on Ludii may be found on its website: \url{https://ludii.games/}. For questions or suggestions, please contact us on the Ludii forums (\url{https://ludii.games/forums/}), or send an email to \href{mailto:ludii.games@gmail.com}{ludii.games@gmail.com}.
...
\include{ChapterXDefines}
\include{ChapterXOptions}
\include{ChapterXRulesets}
\include{ChapterXRanges}
\include{ChapterXConstants}
