...
//			System.out.println("- " + rule);
	 ...
	 */
	private String complete(final EBNFRule rule, final Random rng, final int depth)
	{
		//System.out.println("\nCompleting: " + rule.lhs());	
...
//		System.out.println("clause: " + clause + " " + (clause.isTerminal() ? "T" : "") +  (clause.isRule() ? "R" : "") +  (clause.isConstructor() ? "C" : ""));
	...
	String handleConstructor(final EBNFClause clause, final Random rng, final int depth)
	{
	...
	String handleArg(final EBNFClauseArg arg, final Random rng, final int depth)
	{			
		if (depth > MAX_DEPTH)
		{
