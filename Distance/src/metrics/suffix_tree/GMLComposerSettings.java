...
public interface GMLComposerSettings
{
	...
	public default String getFillColorFromMover(final int mover, final Node nodeState, final SuffixTree suffixTree)
	{
	...
	public static GMLComposerSettings getDefaultInstance()
	{
	...
	public default String getNodeLabel(final Node nodeState) {
		return nodeState.getLabel(true, false);
	}
