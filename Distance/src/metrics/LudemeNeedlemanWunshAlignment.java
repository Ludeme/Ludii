 ...
 * @author Sofia, Markus
 */
public class LudemeNeedlemanWunshAlignment implements DistanceMetric
{
	...
	private Score distance(final String descA, final String descB)
	{
		...
		final EditCost ec = new EditCost();
