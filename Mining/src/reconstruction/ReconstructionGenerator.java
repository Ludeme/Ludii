...
public class ReconstructionGenerator
{
	...
	final static int    defaultNumReconsExpected = 30;
	final static int    defaultNumAttempts       = 20000;
	final static String defaultReconsPath        = "/lud/reconstruction/pending/board/war/leaping/diagonal/Wakanpamungthae";
