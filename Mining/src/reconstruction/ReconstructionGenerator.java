...
public class ReconstructionGenerator
{
	...
	final static int    defaultNumReconsExpected = 11;
	final static int    defaultNumAttempts       = 100000;
	final static String defaultReconsPath        = "/lud/reconstruction/done/board/space/line/Rongmei Naga Alignment Game";
