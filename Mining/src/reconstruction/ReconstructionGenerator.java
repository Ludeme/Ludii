...
public class ReconstructionGenerator
{
	...
	final static int    defaultNumReconsExpected = 20;
	final static int    defaultNumAttempts       = 20000;
	final static String defaultReconsPath        = "/lud/reconstruction/pending/board/war/replacement/checkmate/chaturanga/Shakhmaty (Early Modern)";
