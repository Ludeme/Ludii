package instructionGeneration.old;
...
/**
 * Object for storing the mover and moves made in a game.
 * 
...
public class GameHistory
{
	...
	public GameHistory(final List<List<String>> p1, final List<List<String>> p2, final List<List<Move>> p1m, final List<List<Move>> p2m) 
	{
		player1 = p1;
		player1_moves = p1m;
		player2 = p2;
