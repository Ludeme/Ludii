...
public class LConnectionComponentNew extends JComponent
{
    /** InputField this ConnectionComponent is part of */
    private final LInputFieldNew INPUT_FIELD;
     ...
     */
    public LConnectionComponentNew(LInputFieldNew inputField, boolean fill)
    {
        ...
        public void mouseClicked(MouseEvent e)
        {
            ...
            if(e.getButton() == MouseEvent.BUTTON1)
            {
                if(!filled())
                {
                    ...
                    fill(!filled());
                    graphPanel.connectionHandler().startNewConnection(LConnectionComponentNew.this);
                }
                else
                {
                    ...
                    if(connectedTo != null)
                    {
                        graphPanel.connectionHandler().removeConnection(LConnectionComponentNew.this.lnc().node(), LConnectionComponentNew.this);
                        setConnectedTo(null);
                    }
                    else
                    {
     ...
     */
    public LInputFieldNew inputField()
    {
        return INPUT_FIELD;
    }
