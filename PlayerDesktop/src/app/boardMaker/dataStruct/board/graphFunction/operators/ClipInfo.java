...
/**
 * Class used to store information about the Clip graph function
 */
public class ClipInfo implements GraphInfo {
    // List of ON SCREEN vertices defining the clip zone
    private List<Point> vertices;
    // List of vertices in the board coordinates system defining the clip zone
    private Float[][] updatedVertices;
    private GraphInfo graphFunction;

    private GraphFunction function;

    public ClipInfo(GraphInfo gfct, List<Point> vertices) {
    ...
    public String description() {
        return String.format("(clip %s (poly %s))",graphFunction.description(),printVertices());
    }
    ...
    public void createFunction(Rectangle placement, BoardRange range, Camera camera) {
        ...
        function = new Clip(graphFunction.function(),new Poly(updatedVertices,null));
    }
