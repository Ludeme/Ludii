...
/**
 * Class used to store information about the Keep graph function
 */
public class KeepInfo implements GraphInfo {
    // List of ON SCREEN vertices defining the keep zone
    private List<Point> vertices;
    // List of vertices in the board coordinates system defining the keep zone
    private Float[][] updatedVertices;
    private GraphInfo graphFunction;

    private GraphFunction function;

    public KeepInfo(GraphInfo gfct, List<Point> vertices) {
    ...
    public String description() {
        return String.format("(keep %s (poly %s))",graphFunction.description(),printVertices());
    }
    ...
    public void createFunction(Rectangle placement, BoardRange range, Camera camera) {
        ...
        function = new Keep(graphFunction.function(),new Poly(updatedVertices,null));
    }
