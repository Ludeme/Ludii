...
public class TestFeatureCombinations
{
	...
	public void testA()
	{
		...
		final List<FeatureInstance> newInstances = newFeature.instantiateFeature(game, containerState, 1, -1, -1);
		final List<FeatureInstance> targetInstances = targetFeature.instantiateFeature(game, containerState, 1, -1, -1);
