					...
					final String opponent = 
							...
							(
								...
								(
									",", 
									"playout=softmax",
									"policyweights1=/home/" + userName + "TrainFeaturesFinalStatesBuffers/Out/" + processData.gameName + "_Without/PolicyWeightsCE_P1_00201.txt",
									"policyweights2=/home/" + userName + "TrainFeaturesFinalStatesBuffers/Out/" + processData.gameName + "_Without/PolicyWeightsCE_P2_00201.txt"
								),
								"tree_reuse=true",
								"num_threads=2",
								"final_move=robustchild",
