...
public class BranchingFactorAvg extends Metric
{
	...
	)
	{
		...
		for (int trialIndex = 0; trialIndex < trials.length; trialIndex++)
		{
			...
			{
				System.out.println(context.state().mover() + " UCT: " + Utils.UCTEvaluateState(context, context.state().mover()));
				System.out.println(context.state().mover() + " AB: " + Utils.ABEvaluateState(context, context.state().mover()));
